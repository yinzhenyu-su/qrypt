...
func GenerateTemplate(starterRoot string) ([]byte, error) {
...
# content_dedup = false  # true enables deterministic encrypted content for instant upload/dedup; leaks content equality
