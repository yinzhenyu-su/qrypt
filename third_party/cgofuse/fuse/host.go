...
// SetCapNodeRWLock informs the host that the hosted file system is safe for
// concurrent operations involving the same node [macOS only].
func (host *FileSystemHost) SetCapNodeRWLock(value bool) {
	host.capNodeRWLock = value
}
