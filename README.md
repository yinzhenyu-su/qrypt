...
[![Platforms](https://img.shields.io/badge/platforms-macOS%20%7C%20Linux%20%7C%20Windows-blue)](#requirements)
...
| ---------------------- | ------------------------------ | ------------------------------- | ----------------------------- |
| FUSE                   | [macFUSE](https://macfuse.io/) | none (libfuse3 statically linked) | [WinFsp](https://winfsp.dev/) |
