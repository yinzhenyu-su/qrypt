...
func (d *Driver) uploadSessionStore() *uploadsession.Store[p115OpenUploadSession] {
	return uploadsession.NewStore(uploadsession.StoreOptions[p115OpenUploadSession]{
		Store:      d.stateStore,
